    ...
    <div id="three" class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="text-center"><a class="btn btn-secondary" href="#" >Get Help Now &raquo;</a></div>
            </div>
            <div class="col-md-4">
...
<div class="bg-light py-5">
    <div class="container py-5">
        ...
        <div class="row text-center">
            ...
            <!-- Team item-->
            <div class="col-xl-3 col-sm-6 mb-5">
                <div class="bg-white rounded shadow-sm py-5 px-4"><img id="pp" src="https://bootstrapious.com/i/snippets/sn-about/avatar-1.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
