    ...
    <form method="post" class="container form-container col-lg-6 col-md-8 col-10">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control input-field" placeholder="Enter Occupation" id="occupation" aria-describedby="">
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="form-control input-field" style="height: 4.4rem;">
                    <div class="contact-form-radio ">
                        <input class="input-radio100" id="radio3" type="radio" name="vehicle" value="Yes">
                    ...
                    <div class="contact-form-radio">
                        <input class="input-radio100" id="radio4" type="radio" name="vehicle" value="no">
